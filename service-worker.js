const CACHE = "azri-tasks-v30";
const FILES = ["./", "./index.html", "./style.css?v=1.9.0-94112c0e", "./app.js?v=1.9.0-2cb677b7", "./manifest.webmanifest?v=1.9.0", "./icon.svg?v=1.9.0", "./header-logo.svg?v=1.9.0"];
